...
public class WebViewPlugin extends CordovaPlugin {
    ...
    public static WeakReference<WebViewActivity> webViewActivity = null;
    ...
    // new one
    private void showWebView(final String domain, final String key) {
        SystemWebViewClient.isPreview = true;
        SystemWebViewClient.appDomain = domain;
        SystemWebViewClient.appKey = key;

        LOG.d(LOG_TAG, "domain: " + domain);
        LOG.d(LOG_TAG, "key: " + key);
        //Intent intent = new Intent(this.cordova.getActivity(), WebViewActivity.class);
    ...
    void hideWebView() {
        ...
        LOG.d(LOG_TAG, "hideWebView");
        LOG.d(LOG_TAG, "do nothing for now");
